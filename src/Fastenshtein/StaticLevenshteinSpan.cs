...
public partial class Levenshtein
{
    ...
    public static int Distance<T, TOther>(ReadOnlySpan<T> value1, ReadOnlySpan<TOther> value2)
        where T : IEqualityOperators<T, TOther, bool>
    {
        if (value2.Length == 0)
        {
